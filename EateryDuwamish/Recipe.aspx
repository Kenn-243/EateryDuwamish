...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="page-title">Recipe Master</div><hr style="margin:0"/>
            ...
            <div class="row">
                <div class="table-main col-sm-12">
                    <asp:HiddenField ID="hdfDeletedRecipes" runat="server" Value="0"/>
                    <asp:Repeater ID="rptRecipe" runat="server" OnItemDataBound="rptRecipe_ItemDataBound" OnItemCommand="rptRecipe_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr class="odd" role="row" runat="server" onclick="">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbDetailID" runat="server"  CommandArgument='<%# Eval("RecipeID") %>' OnCommand="lbDetailID_Command">Details</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
