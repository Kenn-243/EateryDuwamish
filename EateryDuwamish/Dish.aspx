        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="table-main col-sm-12">
                    <asp:HiddenField ID="hdfDeletedDishes" runat="server" Value="0"/>
                    <asp:Repeater ID="rptDish" runat="server" OnItemDataBound="rptDish_ItemDataBound" OnItemCommand="rptDish_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr class="odd" role="row" runat="server" onclick="">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtRecipe" runat="server" CommandArgument='<%# Eval("DishID") %>' OnCommand="lbtRecipe_Command">Recipe</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
